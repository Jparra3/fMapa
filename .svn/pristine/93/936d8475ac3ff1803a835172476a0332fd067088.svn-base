...
function cargarVistaPrevia(ruta) {
    $.ajax({
        async: false,
        url: localStorage.modulo + 'ajax/migracion.leerArchivoMigracionServicioProducto.php',
        type: 'POST',
        data: {ruta: ruta},
        dataType: "json",
        success: function(json) {
...
function mostrarVistaPrevia(json){
    ...
    $.each(json.data, function(contador, fila){
        ...
        tabla += "<td class='valorTexto'> "+fila.codigoProductoComposicion+"-"+fila.productoComposicion+" </td>";
...
function visualizartabla(){
    ...
    tabla += "<th> Producto composicion </th>";
...
function registrarInformacionMigracion(){
    $.ajax({
        async: false,
        url: localStorage.modulo + 'controlador/migracionServicioProducto.adicionarInformacion.php',
        type: 'POST',
