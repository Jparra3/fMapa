...
function cargarVistaPrevia(ruta) {
    $.ajax({
        async: false,
        url: localStorage.modulo + 'ajax/migracion.leerArchivoMigracionCliente.php',
        type: 'POST',
        data: {ruta: ruta},
        dataType: "json",
        success: function(json) {
...
function mostrarVistaPrevia(json){
    ...
    $.each(json.data, function(contador, fila){
        ...
        tabla += "<td class='valorTexto'> "+fila.zona+"-"+fila.departamento+" </td>";
        tabla += "<td class='valorTexto'> "+fila.empresa+" </td>";
        tabla += "</tr>";
    });
...
function registrarInformacionMigracion(){
    $.ajax({
        async: false,
        url: localStorage.modulo + 'controlador/migracionCliente.adicionarInformacion.php',
        type: 'POST',
