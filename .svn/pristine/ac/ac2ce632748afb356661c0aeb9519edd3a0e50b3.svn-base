...
function obtenerDatosEnvio(){
    asignarValores();
    data = 'idPedido='+idPedido+'&idCliente='+idCliente+'&idVendedor='+idVendedor+'&idZona='+idZona+'&fechaInicio='+fechaInicio+'&fechaFin='+fechaFin+'&idEstadoPedido='+idEstadoPedido+'&tipoPedido='+tipoPedido;
}
...
function crearListado(json){
    ...
    $.each(json.data, function(contador, fila){
        ...
        table += '<td><span class="fa fa-pencil imagenesTabla" id="imgEditar' + contador + '" title="Editar Pedido" class="imagenesTabla" onclick="editarPedido('+fila.idPedido +')"></span></td>';
        table += '<td align="center"><span class="fa fa-minus imagenesTabla" id="imgAnular' + contador + '" title="Anular Pedido" class="imagenesTabla" onclick="anularPedido('+fila.idPedido +')"></span></td>';
        table += '</tr>';
    });
