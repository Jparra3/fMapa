...
$(function(){
    ...
    document.getElementById('ifrInformacionBasicaPersona').onload = function(){ // Cuando el iframe haya cargado en su totalidad
        ...
        if(idTecnico != "" && idTecnico != null && idTecnico != "null"){
            var data = "idTecnico="+idTecnico;
...
function adicionarTecnico(){
    ...
    $.ajax({
        async:false,
        url: localStorage.modulo + 'controlador/tecnico.adicionar.php',
        type:'POST',
        dataType:"json",
        data:data,
...
function modificarTecnico(){
    ...
    $.ajax({
        async:false,
        url: localStorage.modulo + 'controlador/tecnico.modificar.php',
        type:'POST',
        dataType:"json",
        data:data,
        success: function(json){
