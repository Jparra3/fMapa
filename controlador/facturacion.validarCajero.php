...
try {
    ...
    $retorno["modificaValorVenta"] = $dataCajero[0]["modificaValorVenta"];
    
    $formatoFecha = "Y-m-d H:i:s";
    $date = new DateTime($dataAsignacionCaja[0]["fechaHoraInicial"]);
    $fechaInicio = $date->format($formatoFecha);
    $date = new DateTime($dataAsignacionCaja[0]["fechaHoraFinal"]);
    $fechaFin = $date->format($formatoFecha);
