...
try{
    ...
    $bodyInicial = '<tr><td>
            ...
            <td colspan="5" class="titulo" style="font-size: 16px">
            	ORDEN DE '.$arrOrdenTrabajo['tipoDocumento'].' MAPA DE INGENIERIA
            </td>
            </tr>
            <tr>
            ...
            <tr>
            	...
            	<td></td>
            	<td style="text-align: center; border: 2px solid; border-color: #000;" >'.$arrOrdenTrabajo['fecha'].'</td>            	
            </tr>
            <tr>
