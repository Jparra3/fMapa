...
function cargarVistaPrevia(ruta) {
    $.ajax({
        async: false,
        url: localStorage.modulo + 'ajax/migracion.leerArchivoMigracionInventario.php',
        type: 'POST',
        data: {ruta: ruta},
        dataType: "json",
        success: function(json) {
...
function mostrarVistaPrevia(json){
    ...
    $.each(json.data, function(contador, fila){
        ...
        tabla += "<td class='valorTexto'> "+fila.nitProveedor+" </td>";
        tabla += "<td class='valorTexto'> "+fila.proveedor+" </td>";
        tabla += "<td class='valorTexto'> "+fila.codigo+"-"+fila.producto+" </td>";
        tabla += "<td class='valorNumerico'> "+agregarSeparadorMil(parseInt(fila.cantidad).toString())+" </td>";
        tabla += "<td class='valorTexto'> "+fila.bodega+" </td>";
        tabla += "<td class='valorTexto'> "+fila.serial+" </td>";
        tabla += "<td class='valorTexto'> "+fila.serialInterno+" </td>";
        tabla += "</tr>";
    });
...
function registrarInformacionMigracion(){
    $.ajax({
        async: false,
        url: localStorage.modulo + 'controlador/migracionInventario.adicionarInformacion.php',
        type: 'POST',
